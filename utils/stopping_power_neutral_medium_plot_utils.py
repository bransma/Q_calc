...
# Utility Function
# ======================================================================
def plot_neutral_medium_stopping_power(
    species: list[NeutralMediumStoppingPower],
    ...
    """
    Plot |dE/dx| and Z_eff(E) / Z for one or more species.
    ...
    if labels is None:
        labels = [f"Z={s.Z}, A={s.A}" for s in species]
...
if __name__ == "__main__":
    ...
    plot_neutral_medium_stopping_power(species, labels)